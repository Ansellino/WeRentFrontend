...
export default function FloatingContact() {
  ...
  const waMessage = "Halo WeRent, saya butuh bantuan mengenai ";
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 flex flex-col items-end gap-4">
      ...
      >
        ...
        >
          <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-neutral-900 mt-0.5">
            FAQ
          </span>
        ...
        <a
          href={`https://wa.me/${waNumber}?text=${encodeURIComponent(`${waMessage}produk ${product?.name} (ID: ${id})`)}`}
          target="_blank"
        ...
        >
          <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white mt-0.5">
            WhatsApp
          </span>
